      ...
      <main className="mt-10 space-y-12 pl-4 pr-4">
        ...
        <section>
          ...
          <p className="text-gray-700 text-md">
            Crev is a command-line tool that allows you to easily bundle your
            codebase into a single file so you can share it with an AI. Crev
            also provides an AI code review service that inspects this bundled
            file, provides feedback on your code quality and helps you catch
            bugs early.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              tool. This way you don&apos;t have to pass flags every time you
              run a command.
            </p>
            <pre className="bg-gray-100 border border-gray-300 p-4 rounded-lg text-sm overflow-x-auto">
              crev init
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700 mt-2">
              ...
              by running <strong> crev init</strong> so you don&apos;t have to
              pass these flags every time.
            </p>
          </div>
